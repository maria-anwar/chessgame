...
const RefClock = () => {
  ...
  const [user1ButtonDisabled, setUser1ButtonDisabled] = useState(false);
  const [user2ButtonDisabled, setUser2ButtonDisabled] = useState(false);
      ...
      <section className="flex justify-center py-20 items-center">
        <div className="border flex gap-16 flex-col bg-black py-20 px-52 rounded-md">
          <div className="flex gap-4">
            ...
            {user1ButtonDisabled && <p className="text-white">User 1's time has run out!</p>}
          </div>

          {/* {isUser1Turn ? (isUser1Turn==true ? (<div className=" text-red-500 bg-zinc-900 border rounded-lg px-4 py-2">
           User 1 has made Move
          </div>): <div className=" text-red-500 bg-zinc-900 border rounded-lg px-4 py-2">
          User 2 has made Move
          </div>)
            : <div className="text-red-500">hello Players</div> 
          } */}

            {isUser1Turn==true ? '': (<div className=" text-red-500 bg-zinc-900 border rounded-lg px-4 py-2">
           User 1 has made Move
          </div>)}
          <div className="flex gap-4">
            <div className="flex flex-col gap-1.5">
